...
public class Movie2 
{
    ...
    { 
				...
				output.collect(new Text("Total number of Positive Feedback recieved by the Suspense movies : "), new IntWritable(count));
			}
		}
    ...
    {
			JobConf conf = new JobConf(Movie2.class);
			conf.setJobName("Counting the Positive Reviews");
