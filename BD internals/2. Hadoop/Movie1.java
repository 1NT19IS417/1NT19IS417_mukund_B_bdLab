...
public class Movie1 
{
    ...
    { 
				...
				output.collect(new Text(" No of Movies which can be Refered are : "), new IntWritable(count));
			}
		}
		...
		public static void main(String[] args) throws Exception {
			JobConf conf = new JobConf(Movie1.class);
			conf.setJobName("Counting the Referable Movies");
